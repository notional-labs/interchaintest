...
func (r *HyperspaceRelayer) LinkPath(ctx context.Context, rep ibc.RelayerExecReporter, pathName, mnemonic string, channelOpts ibc.CreateChannelOptions, clientOpts ibc.CreateClientOptions) error {
